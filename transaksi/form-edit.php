 				...
 				<div class="card-body">
 					<form method="post" action="proses-edit.php">
 						...
 						<div class="form-group">
 							...
 							<input type="text" value="<?= $id_pinjam['judul'] ?>" class="form-control" disabled>
 						</div>
 						<div class="form-group">
 							<label for="datepicker">Tanggal pinjam</label>
 							<input type="date" value="<?= $id_pinjam['tgl_pinjam'] ?>" class="form-control">
 						</div>
 						...
 						<div class="form-group">
 							...
 							<input type="date" value="<?= $id_pinjam['tgl_kembali'] ?>" class="form-control">
 						</div>
 						<?php
 						}
 						?>
